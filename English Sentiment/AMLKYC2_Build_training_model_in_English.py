...
long_CompliaceNews =open("Database/Compliance_News_List.txt","r").read()
short_ComplianceAML = open("Database/Compliance_Negative_Word_List.txt","r").read()
short_pos = open("Database/positive.txt","r").read()
short_neg = open("Database/negative.txt","r").read()
...
#Show the original word distribution list before we run the FreqDist command to count the
#frequency of words.
output = open("AMLKYC2_Doc/orig_word_distribution.txt","a")

j = 1
output.write("Original Word distribution:")
output.write('\n')
...
#Run the FreqDist command to count the frequency of words.
...
#output = open("AMLKYC2_Doc/word_features_sentiment.txt","a")  #This file is huge to read.
